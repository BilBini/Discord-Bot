...
export class BaseConfig extends Config {
    ...
    async validate() {
        ...
        if (!config)
            return this.handleValidationErrors(['Empty configuration file, please delete it or fill it with the values. If the error persists, contact the plugin developer.']);
