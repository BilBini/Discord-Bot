...
import { Script, CustomCommand, Command } from '../../../index.js';
import { BaseConfigSection, Service } from '../../contracts/index.js';
...
export default class EngineService extends Service {
    ...
    async handleCustomCommand(id, interaction, user) {
